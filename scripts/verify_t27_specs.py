...
SPEC_MANIFEST: dict[str, dict[str, str | int]] = {
    ...
    "specs/turbobaby/client_errors.t27": {
        ...
        # landed by delegation (9 declarations; the checks were renamed, not added). 249 the
        # same day: the retired age body code's count before that day (the 20+ box, removed).
        "min_declarations": 249,
        "min_checks": 58,
    },
    ...
    "specs/turbobaby/locale_policy.t27": {
        ...
        # two declarations naming the +1; the three together measure 136/35. 138/35 the same
        # day, with the five keys the removed 20+ box used (-5, two declarations naming them).
