...
(async () => {
  ...
  await page.evaluate(() => window.__triggerUpload());
  await page.waitForTimeout(4000);
  
  const effectLogs = logs.filter(l => l.includes('VideoUpload') || l.includes('ADMIN RS') || l.includes('TEST'));
