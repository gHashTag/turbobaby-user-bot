...
fn render_tech_node(id: &str, name: &str, cost: u32, unlocked: bool) -> Element {
    ...
    let bg = if unlocked { "rgba(57,255,20,0.05)" } else { "#1a1a2e" };
    ...
    rsx! {
        ...
        ",
            ...
            div { style: "flex: 1;",
                div { style: "font-size: 14px; font-weight: 700; color: #fff; margin-bottom: 3px;",
                    "{name}"
                }
            ...
            if !unlocked {
                button { style: "
                    ...
                    border: 2px solid #ffe600; border-radius: 8px; cursor: pointer;
                ",
                    "Unlock"
                }
            }
    ...
    rsx! {
        ...
        ",
            ...
            div { style: "text-align: center; margin-bottom: 24px;",
                h1 { style: "font-size: 18px; color: #00e5ff; text-shadow: 0 0 8px rgba(0,229,255,0.5);",
                    "\u{1F333} Tech Tree"
                }
            ...
            ",
                div { style: "background: #0f0f1a; border-radius: 8px; height: 8px; overflow: hidden;",
                    div { style: "background: linear-gradient(90deg, #00e5ff, #39ff14); height: 100%; width: {(unlocked_count * 100 / total)}%; border-radius: 8px;" }
                }
            }
