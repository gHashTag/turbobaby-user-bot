...
pub const T_CHECKOUT_AGE_REQUIRED: Key = "checkout.age.required";
pub const T_CHECKOUT_AGE_DOB: Key = "checkout.age.dob";
pub const T_CHECKOUT_AGE_VERIFY: Key = "checkout.age.verify";
pub const T_CHECKOUT_AGE_VERIFYING: Key = "checkout.age.verifying";
pub const T_CHECKOUT_AGE_UNDERAGE: Key = "checkout.age.underage";
pub const T_CHECKOUT_AGE_ERROR: Key = "checkout.age.error";
...
fn get_ru_translation(key: Key) -> Value {
    match key {
        ...
        T_CHECKOUT_AGE_REQUIRED => "🔞 Для оформления заказа нужно подтвердить возраст (20+).",
        T_CHECKOUT_AGE_DOB => "Дата рождения",
        T_CHECKOUT_AGE_VERIFY => "Подтвердить возраст",
        T_CHECKOUT_AGE_VERIFYING => "Проверка...",
        T_CHECKOUT_AGE_UNDERAGE => "Для заказа нужно быть старше 20 лет.",
        T_CHECKOUT_AGE_ERROR => "Не удалось проверить возраст. Попробуйте позже.",
        T_BACK => "← Назад",
        T_TOTAL => "Итого:",
...
fn get_en_translation(key: Key) -> Value {
    match key {
        ...
        T_CHECKOUT_AGE_REQUIRED => "🔞 Age verification (20+) is required to place an order.",
        T_CHECKOUT_AGE_DOB => "Date of birth",
        T_CHECKOUT_AGE_VERIFY => "Verify age",
        T_CHECKOUT_AGE_VERIFYING => "Verifying...",
        T_CHECKOUT_AGE_UNDERAGE => "You must be 20+ to place an order.",
        T_CHECKOUT_AGE_ERROR => "Could not verify age. Please try again.",
        T_BACK => "← Back",
        T_TOTAL => "Total:",
